...
/**
 * Unbounded request 일 경우, Downstream 에 Backpressure drop_Oldest 전략을 적용하는 예제
 * - DownStream으로 전달 할 데이터가 버퍼에 가득 찰 경우,
 *   버퍼 안에 있는 데이터 중에서 가장 먼저 버퍼로 들어온 오래된 데이터부터 Drop 시키는 전략
 */
public class BackpressureStrategyDropOldestExample {
  ...
  public static void main(String[] args) {
    Flux
        ...
        .doOnNext(data -> Logger.info("# emitted by Buffer: {}", data)) // buffer에서 빠져나가는 내용이다.
