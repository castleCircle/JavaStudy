...
class OrderServiceTest {
  ...
  public void 상품주문() throws Exception{
    ...
    Assertions.assertEquals(8,book.getStockQuantity(),"주 수량만큼 재고가 줄어야 한다.");
  }
  ...
  public void 주문취소() throws Exception{
    ...
    int orderCount = 2;
    final Long order = orderService.order(member.getId(), item.getId(), orderCount);
  ...
  private Member createMember() {
    ...
    member.setName("회원1");
    member.setAddress(new Address("사용","강가","123-123"));
    em.persist(member);
    return member;
  }
